...
第三种则是由伯爵以上的贵族对于他的手下进行授爵。侯爵授予骑士爵，公爵授予男爵。同时授予爵位有着比较严格的限定，要么有军功，要么为帝国做出了巨大的贡献，要么授予者愿意为被授予者做出担保。而且授予名额也有着数量限制，且不能是钱权交易。
...
## 魔法流派
角色魔法属性的判定，每位点了魔法天赋的，需要在此roll **1d(魔法-3)** 确定魔法属性个数，再**魔法属性个数d9** 决定角色的初始魔法属性（低于等于4只有一个属性），如果点击了 **特殊技艺**，则可以在下列三种技艺中选一个，或者自己DIY。
...
### 元素法术
最为基础的魔法类型，也是绝大多数的魔法师所拥有的属性。元素法术包含着多种属性类别，其中，对于帝国最为重要的是雷属性，其他属性，火、水、风、地、冰、雷电六大属性相对而言重要性要弱一些。
